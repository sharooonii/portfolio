...
export const projects = [
  ...
  },
  {
    ...
    description: "Fast-growing online insurance company",
    src: educare,
    color_src: educareColor,
    alt: "Union Faith Corp.",
  ...
  {
    title: "Unigel",
    description: "Chinese B2B exporter to US via Alibaba",
    src: unigel,
    color_src: unigelColor,
    alt: "unigel",
  ...
  },
  {
    ...
    description: "Forum connecting healthcare innovators with key stakeholders",
    src: asgh,
    color_src: asghColor,
  ...
  {
    title: "A1 Bakery",
    description: "Artisanal bakery producing fresh breads and pastries",
    src: a1,
    color_src: a1Color,
    alt: "A1 Bakery",
    companyLogo: a1Logo,
