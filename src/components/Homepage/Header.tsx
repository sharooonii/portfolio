...
export const Header = ({
  ...
  const headerPositionClass = isWhite
    ...
    <>
      {showTopReminder && (
        <div className="bg-spink py-2 text-white w-full">
          <p className="container mx-auto text-center josefin uppercase">
            ✦✦✦{" "}
            <span className="hidden md:inline">welcome to contact me at</span>{" "}
            sharonaa0011@gmail.com ✦✦✦
          </p>
        </div>
      )}
      <div
      ...
      >
        ...
        <div className="flex items-center gap-1 md:hidden">
          <Button
            variant="outline"
            className={`hidden sm:block header-project-button ${
              isWhite
                ? "bg-transparent text-white"
                : "text-spink hover:text-spink hover:bg-lpink/30 border-spink"
            }`}
          >
            Projects
          </Button>
              ...
              <Button
                ...
                className={`${
                  isWhite
                    ...
                    : "text-spink hover:text-spink border-transparent hover:border-spink hover:bg-lpink/30"
                }`}
              >
