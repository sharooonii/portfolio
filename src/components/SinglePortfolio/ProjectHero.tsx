      ...
      <div className="mx-auto container">
        ...
        >
          <img
            src={desktopImgSrc}
            alt={imgAlt}
            className="hidden lg:block w-full mx-auto rounded-2xl object-cover h-full object-left-top"
            draggable={false}
          />
          <img
            src={tabletImgSrc}
            alt={imgAlt}
            className="hidden sm:block lg:hidden w-full mx-auto rounded-2xl object-cover h-full object-left-top"
            draggable={false}
          />
          <img
            src={mobileImgSrc}
            alt={imgAlt}
            className="sm:hidden block w-full mx-auto rounded-2xl object-cover h-full object-left-top"
            draggable={false}
          />
        </ContainerScroll>
      </div>
